...
<tr><td VALIGN=TOP width="626"><h2 align=center>疫情追踪软件安全隐忧 澳专家政府看法不一</h2>

<h6></h6>
<hr>
<p>【大纪元2020年04月23日讯】（大纪元记者徐凯文<ahref="/gb/tag/%E6%BE%B3%E6%B4%B2.md#1">澳洲</a>悉尼编译报导）尽管电讯法律存有争议，澳洲律政部长波特（Christian Porter）誓言要采取监管行动，来禁止警方获取即将发布的手机应用软件的元数据。该手机应用软件旨在跟踪中共病毒（武汉肺炎）<ahref="/gb/tag/%E6%84%9F%E6%9F%93%E8%80%85.md#1">感染者</a>的接触记录。</p>
<p>国家安全与信息技术法<ahref="/gb/tag/%E4%B8%93%E5%AE%B6.md#1">专家</a>已经表示，该软件可记录下手机用户与相距不到1.5米、超过15分钟的其他用户的匿名身份标识。这对于执法机构调查取证两人之间的接触记录极具吸引力。</p>
<p>政府服务部长罗伯特（Stuart Robert）称，该软件的元数据将不会对警方开放。总理莫里森（Scott Morrison）周二表示只有政府的卫生“侦测人员”会获取数据，但是<ahref="/gb/tag/%E4%B8%93%E5%AE%B6.md#1">专家</a>说，现有法律将有可能允许执法机构获得此应用软件的元数据。</p>
<p>新南威尔士大学法学教授摩西（Lyria Bennett Moses）表示，政府可以依据2018年通过的有争议的电信法来强行获取数据。他说，对于情报机构或是州警察而言，他们依然可以利用此法律以自愿或是强制的方式用加密程序获取数据。</p>
<p>但是波特对悉尼晨锋报和时代报表示，他将禁止执法机构获取软件的元数据。他补充说，更多详细信息将会在软件正式发布的时候提供。政府已经决定不会以其它目的收集数据，包括执法调查。</p>
<p>专家称，如果警方要调查一名在染疫者身旁逗留超过15分钟的谋杀嫌疑犯，而且双方都装有该软件，警方有可能在没有搜查令的情况下，获取嫌疑人的数据。</p>
<p>根据犯罪法，警方可在获得搜查许可令后，解锁犯罪嫌疑人的手机并检查数据，包括该追踪病毒患者的手机应用软件收集的数据。</p>
<p>而根据18个月前通过的电讯法显示，执法机构如果在调查严重犯罪，则可获取元数据，无需出示搜查令。该法律基本上尚未经过实际验证。</p>
<p>元数据监管研究员彻奇斯（Genna Churches）表示，元数据也可根据最近在各州通过的公共卫生应急法以及长久以来的生物紧急安全法获得。</p>
<p>彻奇斯和摩西教授都表示担心。因为该软件收集的数据会在中心云端数据库中储存，很有可能遭到入侵，或许永远不会被删除。摩西教授敦促政府修订国家安全法，将此软件获取的元数据作为例外。</p>
<p>责任编辑：岳明</p>
...
<li><a href="/gb/19/3/20/n11125994.md#1" target="_blank">谁是中华文化的最大破坏者？</a></li><li><a href="/gb/13/11/27/n4020290.md?dfh#1" target="_blank">大陆见不到的震撼场面</a></li><li><a href="/gb/12/9/5/n3676026.md#1" target="_blank">老警察讲的笑话让人想哭</a></li>
<hr>
