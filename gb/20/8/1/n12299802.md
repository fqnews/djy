...
<tr><td VALIGN=TOP width="626"><h2 align=center>收录二十亿个星系 巨型宇宙三维图绘制完成</h2>
<img width="600" src="https://i.epochtimes.com/assets/uploads/2020/08/fkk-ji8Q-600x400.jpeg" />
<h6>三维宇宙地图。（Anand Raichoor/EPFL, Ashley Ross/OSU and the SDSS Collaboration）
</h6>
<hr>
	<p>【大纪元2020年08月01日讯】（大纪元记者笛睿编译）天文学家绘制完成一份巨型<ahref="/gb/tag/%E4%B8%89%E7%BB%B4%E5%AE%87%E5%AE%99%E5%9C%B0%E5%9B%BE.md#1">三维宇宙地图</a>，包括了20亿个星系和类星体，是有史以来最详尽的一份。项目组表示，从中看到了“完整的宇宙膨胀历史”。</p>
<p>这份地图以数字天空调查（Sloan Digital Sky Survey，简称SDSS）项目六年来搜集的数据为基础，填补了天文学家对早期宇宙和近代宇宙之间110亿年历史的空白。</p>
<p>“我们对早期的宇宙和近期宇宙的膨胀信息都比较了解，但是之间110亿年的情况并不了解。”项目负责人犹他大学（University of Utah）宇宙学家道森（Kyle Dawson）说。</p>
<p>项目组还采用了SDSS的分支——重子振荡光谱调查（eBOSS）的数据。</p>
<p>“eBOSS的细节分析，结合SDSS早期的数据，提供了至今为止时间跨度最广、最准确的宇宙膨胀历史信息。这些研究数据让我们看到了宇宙膨胀整个过程。”eBOSS的研究员珀西瓦尔（Will Percival）说。</p>
<p>这份地图的数据从宇宙诞生后仅30万年的时间点开始。</p>
<p>“从地图上看出，大约60亿年前，宇宙开始加速膨胀，之后膨胀的速度越来越快。这似乎与看不见的‘暗能量’相关，这与爱因斯坦相对论一致，但是用现代的粒子物理很难解释得通。”该项目在媒体公告中写道。</p>
<p>大部分科学家认为，暗能量是推动宇宙加速膨胀的神秘因素，但是现在还无法确定其构成。据space.com报导，2012年发表的一份国际研究认为，暗能量真实存在的可能性达到99.996%。</p>
<p>这份地图发布了静态图片和三维动画两个版本，用彩虹色给不同范围的宇宙分区，以地球为中心，越往外围看到的是越早期的宇宙。</p>
<p>“我们向远处看去，看到的是过去的景象。所以，这些信号解释了宇宙历史上不同时期的膨胀率。”SDSS地图的配文中写道。</p>
<p>此外，地图上还有一些黑色的区域，天文学家称那部分宇宙被银河系挡住了，因此观测不到。</p>
<p>现在科学家用不同方法计算出来的宇宙膨胀系数并不一致。比如，将eBOSS的数据和之前对早期宇宙的研究进行对比，发现目前广泛接受的膨胀率——哈勃常数，比根据观测距离我们较近的、周围星系之间距离算出的膨胀系数慢了近10%。◇</p>
<p>责任编辑：朱涵儒</p>
